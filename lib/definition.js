...
var Definition = function(config){
  ...
  // validate that there is a "constructor" or "function" property
  if(typeof __config.constructor !== 'string' && typeof __config.function !== 'string'){
    throw new Error('Definition config must have either a "constructor" or "function" property.');
  }
  ...
  this.hasAlias = function(){
    return typeof __config.alias !== 'undefined' && __config.alias !== null;
  }
  ...
  this.getFunction = function(){
    return __config.function;
  }

  /**
   * Check if this is referencing a function (vs a constructor)
   *
   * @return {Boolean}
   */
  this.isFunction = function(){
    return !(typeof __config.function === 'undefined');
  }
