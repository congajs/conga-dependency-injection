...
describe('Definition instance instatiation:', function() {
  ...
  it('should throw an error without a constructor or function config property', function(){
    (function() {
      return new Definition({ id : 'my.id' });
    }).should.throwError('Definition config must have either a "constructor" or "function" property.');
  });
